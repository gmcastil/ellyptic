...
class TestDiscretes():
    ...
    def test_RF(self):
        ...
        assert_approx_equal(carlson.R_F(1j, -1j, 0, rtol=1E-40),
                            1.8540746773014,
                            significant=14)
        assert_approx_equal(carlson.R_F(1j-1, 1j, 0, rtol=1E-40),
                            0.79612586584234-1.2138566698365j,
                            significant=14)
        assert_approx_equal(carlson.R_F(2, 3, 4, rtol=1E-40),
                            0.58408284167715,
                            significant=14)
        assert_approx_equal(carlson.R_F(1j, -1j, 2, rtol=1E-40),
                            1.0441445654064,
                            significant=14)
        assert_approx_equal(carlson.R_F(1j-1, 1j, 1-1j, rtol=1E-40),
